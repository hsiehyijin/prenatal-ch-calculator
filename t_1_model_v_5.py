...
with col1:
    ...
    age = st.number_input("Maternal Age", min_value=15.0, max_value=55.0, value=32.0)
...
with col2:
    ...
    def load_ch_model(target_name):
        path_map = {
            ...
            "Livebirth": "bootstrapped_Naive_Bayes_models_Livebirth.pkl",
            "OtherChroms": "bootstrapped_SVM_RBF_models_OtherChroms.pkl"
        }
